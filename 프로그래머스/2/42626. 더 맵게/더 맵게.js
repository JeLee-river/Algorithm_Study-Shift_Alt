class Heap {
    ...
    bottomUp(currentNodeIndex){
        while(currentNodeIndex > 0){
            ...
            if(this.nodeList[parentNodeIndex] <= this.nodeList[currentNodeIndex]) break;
            
            [this.nodeList[parentNodeIndex], this.nodeList[currentNodeIndex]] = [this.nodeList[currentNodeIndex], this.nodeList[parentNodeIndex]];
    ...
    topDown(currentNodeIndex){
        while(true){
            ...
            if(rightChildNodeIndex < this.nodeList.length && this.nodeList[rightChildNodeIndex] < this.nodeList[leftChildNodeIndex]){
                smallestNodeIndex = rightChildNodeIndex;
            }
            
            if(smallestNodeIndex === null || this.nodeList[currentNodeIndex] <= this.nodeList[smallestNodeIndex]) break;
            
            [this.nodeList[currentNodeIndex], this.nodeList[smallestNodeIndex]] = [this.nodeList[smallestNodeIndex], this.nodeList[currentNodeIndex]];
